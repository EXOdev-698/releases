...
export ROM="RadiantOS-12"
export ROM_DIR="${WORKSPACE}/../RadiantOS-12-12"
export ROM_VERSION="12.0"
export official="false"
export local_manifest_url="https://raw.githubusercontent.com/JonnyRoller23/manifest/main/radiant-12-olivellite.xml"
export manifest_url="https://github.com/ProjectRadiant/manifest"
export rom_vendor_name="radiant"
