...
export ROM="LineageOS-12"
export ROM_DIR="${WORKSPACE}/../LineageOS-olivelite-12"
export ROM_VERSION="12.0"
export official="false"
export local_manifest_url="https://raw.githubusercontent.com/JonnyRoller23/manifest/main/lineage-12-olivelite.xml"
